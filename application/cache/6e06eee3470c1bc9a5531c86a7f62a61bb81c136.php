...
<?php $__env->startSection('title', "BDD | News Study"); ?>
<?php $__env->startSection('page-title', 'News Study'); ?>
...
<div id="case-form-app" class="uk-background-default" style="padding-top: 20px !important">
	...
	<form id="content_form"
		action="<?php echo e(!empty(@$row) ? base_url('newsUpdate/editNews/' . $row->id) : base_url('newsUpdate/addNews')); ?>"
        ...
        <div class="main-title" style="z-index: 980;" uk-sticky="bottom: #offset;animation: uk-animation-slide-bottom-small">
            <div class="uk-card uk-card-default uk-card-body" style="padding: 10px 20px 0px 20px">
                <div class="uk-float-left">
                	<h3 class="uk-text-muted"><?php echo e(!empty(@$row) ? 'Edit News' : 'Add News'); ?></h3>
                </div>
			...
			<div class="uk-card uk-card-default uk-card-body uk-grid-small" uk-grid>
                ...
                <div class="uk-width-1-1@s">
					...
					<input class="uk-input" type="text" placeholder="Streatments" name="streatments"
						value="<?php echo e(!empty(@$row) ? $row->streatments : ''); ?>">
				</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u6065760/public_html/bolehdicoba.com/beta/application/views/admin/blog/news-form.blade.php ENDPATH**/ ?>