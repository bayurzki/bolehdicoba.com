            ...
            <div class="append-nav"></div>
                <div class="news-detail owl-carousel owl-theme">
                    ...
                    <?php if($carousel_row->id == $news_id): ?>
                        <?php continue; ?>;
                    <?php endif; ?>
                    <a href="<?php echo base_url() . 'news-and-update/' . str_replace(' ', '-', $carousel_row->name) . '/' . $carousel_row->id ?>">
                        <div class="post">
...
<?php echo $__env->make('webpage.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u6065760/public_html/bolehdicoba.com/beta/application/views/webpage/news-detail.blade.php ENDPATH**/ ?>