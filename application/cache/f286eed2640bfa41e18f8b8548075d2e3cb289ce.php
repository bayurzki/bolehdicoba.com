...
<?php $__env->startSection('title', "About | Boleh Dicoba Digital"); ?>
<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('webpage.layouts.navbar', ['about' => 'active'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <section id="what-we-do">
      <div class="container container-no-left small--hide">
        <div class="row justify-content-center">
          <div class="col-sm-5">
            <img src="<?php echo base_url() ?>assets/webpage/images/about-banner-1@2x.png" class="img-fluid">
          </div>
      ...
      <div class="medium-up--hide">
        <div class="row">
          ...
          <div class="col-sm w-small--90">
            <img src="<?php echo base_url() ?>assets/webpage/image-mobile/mbl-about-image-banner@2x.png" class="img-fluid">
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="row align-items-center">
        <div class="col-md-6">
          ...
          <p data-aos="fade-right" data-aos-delay="400" class="mt-4 mb-5">
            We are a team of practitioners. We know the game. We play the game. We live in the game.
            <br/><br/>
    ...
    <div class="container-full-width bdd-why_work-bg position-relative" id="why-work">
      <div class="container">
        <div class="row py-desktop-5 pt-mobile-5">
          <div class="col-sm small--hide">
            <img src="<?php echo base_url() ?>assets/webpage/images/about-banner-4.png">
          </div>
      ...
      <div data-aos="fade-right" data-aos-delay="200" class="col-10 medium-up--hide">
        <img src="<?php echo base_url() ?>assets/webpage/images/about-banner-4.png" class="img-fluid">
      </div>
    </div>
    <!-- end section -->
    ...
    <div class="container-full-width mt-custom" id="meet-the-team">
      <div class="container">
        <div class="small--text-center py-5">
          ...
          <div class="py-2 opacity-0 medium-up--hide">
            <button type="button" class="btn bg-white">
              <img src="<?php echo base_url() ?>assets/webpage/icons/12/blackright_arrow_ic@3x.svg" class="img-fluid" style="opacity: 0.5; transform: rotate(-180deg);">
            </button>
            <button type="button" class="btn bdd-primary-btn">
        ...
        <div class="container-fluid-mobile">
          <div class="row">
            ...
            <?php $__currentLoopData = $teams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <div class="card mb-4 mr-2 border-0" style="padding: 12px; width: 299px;">
                <img src="<?php echo e($team['image']); ?>" class="card-img-top" alt="..." style="height: 275px; object-fit: cover; width: 100%;">
                <div class="card-body text-center">
                  <div class="card-title">
                    <h5 class="mb-0"><?php echo e($team['nama']); ?></h5>
                    <span class="text-secondary-small mb-3"></span>
                  </div>
                  <p class="card-text p-2">
                    <?php echo e($team['jabatan']); ?>
...
<?php echo $__env->make('webpage.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u6065760/public_html/bolehdicoba.com/beta/application/views/webpage/about.blade.php ENDPATH**/ ?>