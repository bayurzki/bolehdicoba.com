    		...
    		<div class="row">
    			<div class="col-md-6">
    				<a href="<?php echo e(base_url() . 'assets/images/events/ramadhan-insights.jpeg'); ?>" target="_blank">
    					<img src="<?php echo e(base_url() . 'assets/images/events/ramadhan-insights.jpeg'); ?>" class="img-fluid">
    				</a>
    			</div>
    			<div class="col-md-6 pt-mobile-4">
    				<form class="pb-mobile-4 w-75" style="margin: auto;" action="https://docs.google.com/forms/u/5/d/e/1FAIpQLSc9TvgnJKJjmrMnw0O5kyFQhIejj4btFuXijvZYcT73mT8_1A/formResponse">
		    			...
		    			<div class="form-group">
		    				...
		    				<input type="text" name="entry.11297993" class="form-control" />
		    			</div>

		    			<div class="form-group">
		    				<label class="label-control">Email</label>
		    				<input type="email" name="entry.410317758" class="form-control" />
		    			</div>
...
<?php echo $__env->make('webpage.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u5891500/public_html/application/views/webpage/ramadhan-insight.blade.php ENDPATH**/ ?>