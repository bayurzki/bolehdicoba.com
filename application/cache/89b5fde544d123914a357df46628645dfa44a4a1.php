            ...
            <script type="application/ld+json">
              {
                ...
                "@type": "BlogPosting",
                "mainEntityOfPage": "<?php echo e($url); ?>",
                "articleSection": "<?php echo e($row->sub_title); ?>",
                "keywords": "",
                "headline": "<?php echo e($row->title); ?>",
                "description": "<?php echo e($row->description); ?>",
                "dateCreated": "<?php echo e($row->created_at); ?>",
                "datePublished": "<?php echo e($row->created_at); ?>",
                "dateModified": "<?php echo e($row->created_at); ?>",
                "image": {
                  "@type": "ImageObject",
                  "url": "<?php echo e(base_url() . 'assets/images/' . $row->img_path); ?>",
                  "image": "<?php echo e(base_url() . 'assets/images/' . $row->img_path); ?>",
                  "name": "<?php echo e($row->title); ?>",
                  "width": "1024",
                  "height": "1024"
                },
                "author": {
...
<?php echo $__env->make('webpage.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u5891500/public_html/application/views/webpage/news-detail.blade.php ENDPATH**/ ?>