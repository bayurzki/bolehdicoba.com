                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-9 second-banner position-relative">
                                    <?php
                                        $index = 0;
                                        $length = count($gallery->result());
                                        ?>
                                    <?php $__currentLoopData = $gallery->result(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gallery_row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                        
                                    <?php if($index == 0): ?>
                    ...
                    <div class="container-full-width h-550 d-flex flex-column justify-content-center bg-light pb-mobile-5">
                        ...
                        <div class="append-nav"></div>
                            <div class="news-detail owl-carousel owl-theme">
                                ...
                                <?php if($carousel_row->id == $row->news_id): ?>
                                    <?php continue; ?>;
                                <?php endif; ?>
                                <a href="<?php echo base_url() . 'news-and-update/' . $carousel_row->name . '/' . $carousel_row->id ?>">
                                    <div class="post">
...
<?php echo $__env->make('webpage.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Panji\xampp\htdocs\bdd-v2\application\views/webpage/news-detail.blade.php ENDPATH**/ ?>