            ...
            <div class="append-nav"></div>
                <div class="case-detail owl-carousel owl-theme">
                    ...
                    <?php if($carousel_row->id == $case_id[0]): ?>
                        <?php continue; ?>;
                    <?php endif; ?>
                    <a href="<?php echo base_url() . 'case-study/' . str_replace(' ', '-', $carousel_row->name) . '/' . $carousel_row->id ?>">
                        <div class="post">
...
<?php echo $__env->make('webpage.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Panji\xampp\htdocs\bdd-v2\application\views/webpage/case-detail.blade.php ENDPATH**/ ?>