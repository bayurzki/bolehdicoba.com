...
<?php $__env->startSection('content'); ?>
        ...
        <div class="row justify-content-center justify-content-end">
          ...
          <div class="col-sm-7 d-flex align-items-center padding-about-us pt-mobile-5">
            <div class="pl-mobile-3 pb-mobile-4">              
                <span data-aos="fade-left" data-aos-delay="200" class="heading text-secondary-small"><?php echo e($row->category); ?></span>
                <h1 data-aos="fade-left" data-aos-delay="350"><span style="text-transform: uppercase;font-weight: bold;"><?php echo e($row->name); ?></span>: Deliver the value of #CarryNewFun to reach the right audience.</h1>
                <h2 data-aos="fade-left" data-aos-delay="350" class="medium-up--hide"><?php echo e($row->title); ?></h2>
                <!-- <a href="<?php echo base_url('case-study/' . str_replace(' ', '-', strtolower($row->category)) . '/' . str_replace(' ', '-', preg_replace('/:|&\s|,|;|\.|#/', '', $row->title)) . '/' . $row->id); ?>" class="btn bdd-primary-btn mt-5 small--hide" style="font-family: Gelion-SemiBold;">Read More <img src="<?php echo base_url() ?>assets/webpage/icons/12/blackright_arrow_ic@3x.svg"> </a>
                <a href="<?php echo base_url('case-study/' . str_replace(' ', '-', strtolower($row->category)) . '/' . str_replace(' ', '-', preg_replace('/:|&\s|,|;|\./', '', $row->title)) . '/' . $row->id); ?>" class="btn bdd-primary-btn mt-3 medium-up--hide" style="font-family: Gelion-SemiBold;">See Case Studies <img src="<?php echo base_url() ?>assets/webpage/icons/12/blackright_arrow_ic@3x.svg"> </a>                 -->
            </div>
          </div>
      ...
      <div class="container">
        <div class="text-left mb-3">
          <div class="text-left d-flex flex-column">
            ...
            <h1 data-aos="fade-right" data-aos-delay="350" class="small--hide"><?php echo $row->description; ?></h1>
            <h3 data-aos="fade-right" data-aos-delay="350" class="medium-up--hide"><?php echo $row->description; ?></h3>
          </div>
        </div>
        <div class="text-right d-flex flex-column">
          <h5 data-aos="fade-left" data-aos-delay="350" class="font-medium bdd-font-blue small--hide">- <?php echo e($row->sub_title); ?></h5>
          <h5 data-aos="fade-left" data-aos-delay="350" class="font-medium bdd-font-blue medium-up--hide">- <?php echo e($row->title); ?></h5>
    ...
    <section id="case-studies">
      <div class="bbd-blue_dark-bg py-5 mt-5 pmy-6em dmt-7em" id="case-studies">
          ...
          <!-- <a href="<?php echo base_url() . 'case-study/' . str_replace(' ', '-', strtolower($results[0]->category)) . '/' . str_replace(' ', '-', preg_replace('/:|&\s|,|;|\./', '', $results[0]->title)) . '/' . $results[0]->id ?>">
...
<?php echo $__env->make('webpage.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u6065760/public_html/bolehdicoba.com/beta/application/views/webpage/case-study.blade.php ENDPATH**/ ?>