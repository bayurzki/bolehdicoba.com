<div class="tm-sidebar-left uk-visible@m uk-background-default uk-text-center">
  <div class="uk-width-expands@m">
    <a href="<?= base_url('Admin/dashboard') ?>" class="uk-text-muted uk-flex-center">
      <img src="<?= base_url() ?>assets/images/bdd-logo-no-text.png" width="40" alt="" srcset="" style="border: solid # c1c1c1; border-radius: 10px; ">
    </a>
  </div>
...
<?php /**PATH /home/u6065760/public_html/bolehdicoba.com/beta/application/views/layouts/navbar.blade.php ENDPATH**/ ?>