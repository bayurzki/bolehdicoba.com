...
<div id="dashboard-app" class="bdd-padding-header uk-background-default" style="padding-top: 20px !important">  
	...
	<div class="main-title uk-clearfix uk-margin-small-bottom">
		<div class="uk-float-left">
			<h3 class="uk-text-muted">News Posts List</h3>
		</div>
		<div class="uk-float-right">
			<a href="<?= base_url('admin/newsPostsForm'); ?>" class="uk-button uk-button-primary uk-rounded">Add News Posts</a>
		</div>
	</div>
				...
				<table class="uk-table uk-table-striped" id="main-content-list-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url('admin/newsPostsForm/' . $item->id) ?>">Edit</a>
                                <a onclick="deleteConfirm(<?php echo e($item->id); ?>)" href="#!">Delete</a>
                                <!-- <input id="url-data" value="<?php echo e(base_url('admin/deleteNewsPosts/')); ?>" type="hidden" />
                                <input id="style-type" value="<?php echo e($item->name); ?>" type="hidden" /> -->
                                <a id="delete-<?php echo e($item->id); ?>" href="<?php echo base_url('admin/deleteNewsPosts/'. $item->id . '/' . $item->name) ?>" hidden></a>
                            </td>
                        </tr>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u6065760/public_html/bolehdicoba.com/beta/application/views/admin/blog/component-news-dashboard.blade.php ENDPATH**/ ?>