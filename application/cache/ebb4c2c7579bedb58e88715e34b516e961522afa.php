<nav class="navbar navbar-expand-lg navbar-light">
    <div class="container-fluid container-sm navbar-container">
      ...
      <a class="navbar-brand mb-auto col-4 mr-0" href="<?php echo base_url() ?>">
          <img src="<?php echo base_url() ?>assets/webpage/images/bdd-logo.png" class="img-fluid small--hide" width="170">
          <img src="<?php echo base_url() ?>assets/webpage/images/bdd-logo.png" class="img-fluid medium-up--hide">
      </a>
      <a href="<?php echo base_url() ?>webpage/about#why-work">
      ...
      <div class="collapse navbar-collapse w-small-100 small--text-center m-mobile-auto" id="navbarNav">
        <ul class="navbar-nav mr-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link p-3 font-medium <?php echo e($news ?? ''); ?>" href="<?php echo base_url() ?>news-and-update">News & Update</a>
          </li>
        </ul>
        <a class="small--hide" href="<?php echo base_url() ?>case-study">
          <button type="button" class="btn bdd-primary-btn ml-4 small--hide">Get Started</button>
        </a>
      </div>
    </div>
  </nav><?php /**PATH C:\Panji\xampp\htdocs\bdd-v2\application\views/webpage/layouts/navbar.blade.php ENDPATH**/ ?>