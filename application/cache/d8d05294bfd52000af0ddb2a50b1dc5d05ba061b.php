				...
				<table class="uk-table uk-table-striped" id="main-content-list-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo e(base_url('admin/newsPosts/' . $item->name . '/' . $item->id)); ?>">
                            ...
                            <td>
                                ...
                                <a id="delete-<?php echo e($item->id); ?>" href="<?= base_url('admin/deleteNews/' . $item->id) ?>" hidden></a>
                            </td>
                        </tr>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u6065760/public_html/bolehdicoba.com/beta/application/views/admin/blog/news-dashboard.blade.php ENDPATH**/ ?>