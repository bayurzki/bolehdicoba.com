...
<?php $__env->startSection('content'); ?>
    ...
    <section id="recently-news">
      <div class="container container-no-left">
        <div class="row justify-content-center">
          ...
          <div class="col-sm d-flex align-items-center padding-wwd pt-mobile-5 pb-mobile-4">
            <div>
              <span class="heading text-secondary-small"><?php echo e(@$row->category); ?></span>
              <h1 class="title font-24"><?php echo e(@$row->title); ?></h1>
              <a href="<?php echo base_url('news-and-update/' . @$row->name . '/' . @$row->id); ?>"> 
    ...
    <section id="our-streatments">
      <div class="container p-25">
          <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>              
          <span class="heading text-secondary-small text-uppercase pb-2">our streatments</span>
          <h1 class="our-streatment font-20">“<?php echo e(@$row->streatments); ?>”</h1>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </div>
    </section>
    <!-- end section -->
          ...
          <div class="posts position-relative">
            <div class="popular-post owl-carousel owl-theme">
              ...
              <div class="posts-content">
                <a href="<?php echo e(base_url( 'news-and-update/' . @$row->name . '/' . @$row->id)); ?>">
    ...
    <section id="news-and-blog">
      <div class="container">
        ...
        <!-- Desktop menu -->
        <ul id="desktop-menu" class="blog-nav d-flex p-0 small--hide">          
          <li class="blog-menu"> 
        ...
        $.ajax({
          ...
          success(res) {
            ...
            res.filtered.map((item, i) => {
              ...
              filterTag.innerHTML += `                 
                 <div key="${i}" class="mb-4 col-6 col-sm-8 col-md-6 col-lg-4">
                   <div style="overflow: hidden;">
                      <a href="<?= base_url('news-and-update/${item.name}/${item.id}') ?>">
...
<?php echo $__env->make('webpage.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Panji\xampp\htdocs\bdd-v2\application\views/webpage/news-and-update.blade.php ENDPATH**/ ?>