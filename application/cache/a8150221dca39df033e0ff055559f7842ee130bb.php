    ...
    <section id="recently-news">
      <div class="container container-no-left">
        <div class="row justify-content-center">
          ...
          <div class="col-sm-7 d-flex align-items-center padding-wwd pt-mobile-5 pb-mobile-4">
            <div>
              <span data-aos="fade-left" class="heading text-secondary-small"><?php echo e(@$row->category); ?></span>
              <h1 data-aos="fade-left" data-aos-delay="200" class="title font-24"><?php echo e(@$row->title); ?></h1>
...
<?php echo $__env->make('webpage.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u6065760/public_html/bolehdicoba.com/beta/application/views/webpage/news-and-update.blade.php ENDPATH**/ ?>