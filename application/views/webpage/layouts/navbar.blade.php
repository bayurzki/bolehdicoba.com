    ...
    <div class="container-fluid container-sm navbar-container">
      ...
      <div class="collapse navbar-collapse w-small-100 small--text-center m-mobile-auto" id="navbarNav">
        <ul class="navbar-nav mr-auto mb-2 mb-lg-0">
          <li class="nav-item">
          <a class="nav-link p-3 font-medium {{ $about ?? '' }}" aria-current="page" href="<?php echo base_url() ?>about">About Us</a>
          </li>
          <li class="nav-item">
            <a class="nav-link p-3 font-medium {{ $whatwedo ?? '' }}" href="<?php echo base_url() ?>what-we-do">What We Do</a>
          </li>
          <li class="nav-item">
            <a class="nav-link p-3 font-medium {{ $casestudy ?? '' }}" href="<?php echo base_url() ?>case-study">Case Study</a>
          </li>
          <li class="nav-item">
            <a class="nav-link p-3 font-medium {{ $news ?? '' }}" href="<?php echo base_url() ?>news-and-update">5-Mins Essentials</a>
          </li>
          <li class="nav-item">
            <a class="p-3 font-medium btn bdd-primary-btn" href="https://wa.me/6281944345758" target="_blank">Free Consultation</a>
          </li>
        </ul>
