                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <!-- <input id="url-data" value="{{ base_url('admin/deleteNewsPosts/') }}" type="hidden" />
                                <input id="style-type" value="{{ $item->name }}" type="hidden" /> -->
                                <a id="delete-{{ $item->id }}" href="<?php echo base_url('admin/deleteNewsPosts/'. $item->id . '/' . $item->name) ?>" hidden></a>
                            </td>
                        </tr>
                        @endforeach 
                        @endif             
