<div class="tm-sidebar-left uk-visible@m uk-background-default uk-text-center">
  ...
  <div class="uk-width-expand@m uk-margin-large">
    <ul class="uk-nav uk-nav-default" style="font-size:12px;">
      <li class="bdd-menu-{{ $dashboard ?? 'inactive'}}" uk-tooltip="title: Case Study; pos: right; offset: 5">
      ...
      <li class="bdd-menu-{{ $news ?? 'inactive'}}" uk-tooltip="title: News & Update; pos: right; offset: 5">
      ...
      <li class="bdd-menu-{{ $website ?? 'inactive'}}" uk-tooltip="title: BDD Website; pos: right; offset: 5">
